...
Spam messages are unsolicited SMS texts that can be annoying or malicious, making automatic detection important for user safety and experience.[1]
This project builds and evaluates a classifier that distinguishes between legitimate (ham) and spam SMS messages based on their content.[1]
...
[1](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/43744170/55e974e7-ed2f-49fd-b9f0-3919e9ea350d/Naive-Byes.ipynb)
